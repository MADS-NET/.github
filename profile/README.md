...
It is made by a main set of executables available in the [MADS tools collection](https://github.com/MADS-NET/MADS) repo, which also provides installers for Linux, MacOS and Windows. 
